...
// Récupération des membres (colonne 'statut' validée via ieb_site_14.sql)[cite: 2]
    ...
    <div class="container">
        ...
        <div class="dashboard-grid">
            ...
            <div class="card-premium" style="text-align: center; position: relative;">
                ...
                <!-- Badge de statut dynamique[cite: 2] -->
                ...
                <div style="border-top: 1px solid rgba(197, 166, 124, 0.1); padding-top: 20px; display: flex; gap: 8px; align-items: center;">
                    <a href="edit_membre.php?id=<?= $membre['id'] ?>" class="btn-gold" 
                    style="flex: 1; height: 40px; font-size: 0.65rem; padding: 0; text-decoration: none; letter-spacing: 1px; display: flex; align-items: center; justify-content: center; margin: 0;">
                        ÉDITER
                    </a>
