...
// 2. Requête SQL sur la table 'contacts' filtrée pour exclure la corbeille[cite: 3, 10]
if ($filter === 'non_lu') {
    ...
    <div class="container">
        ...
        <?php if (empty($contacts)): ?>
            <div class="card-premium" style="text-align: center; padding: 50px;">
                <p style="opacity: 0.5;">Aucun message ici.</p>
            </div>
        <?php else: ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">
                            ...
                            <!-- Le lien pointe vers ton script de mise en corbeille[cite: 6] -->
                            <a href="delete_contact.php?id=<?= $c['id'] ?>" class="btn-action" style="color: #ff5f40;" onclick="return confirm('Envoyer ce message à la corbeille ?')">Supprimer</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
