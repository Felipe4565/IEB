        ...
        <div class="hero-overlay">
            <div class="container hero-container">
                ...
                <div class="hero-text-content">
                    <?php if(!empty($projet['type'])): ?>
                        <span class="category-label reveal"><?= htmlspecialchars($projet['type']) ?></span>
                    <?php endif; ?>
    ...
    <div class="container">
        <section class="project-info-grid">
            <div class="content-text reveal">
                ...
                <p class="description-large">
                    <?= !empty($projet['description']) ? nl2br(htmlspecialchars($projet['description'])) : "Une réalisation d'exception." ?>
                </p>
            </div>
            ...
            <div class="specs-box reveal">
                ...
                <div class="spec-item">
                    ...
                    <span class="value"><?= htmlspecialchars($projet['localisation']) ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="spec-item">
                    ...
                    <span class="value"><?= htmlspecialchars($projet['materiaux']) ?></span>
                </div>
                <?php endif; ?>
            </div>
        </section>
        ...
        <section class="project-gallery-section reveal">
            <div class="gallery-intro">
                <h2 class="section-title">GALERIE DE RÉALISATION</h2>
            </div>
